...
module aurorafw.graphics.platform.opengl.gl;
...
enum uint GL_SHADER_BINARY_FORMAT_SPIR_V = 0x9551;
enum uint GL_SPIR_V_BINARY = 0x9552;
enum uint GL_PARAMETER_BUFFER = 0x80EE;
enum uint GL_PARAMETER_BUFFER_BINDING = 0x80EF;
enum uint GL_CONTEXT_FLAG_NO_ERROR_BIT = 0x00000008;
enum uint GL_VERTICES_SUBMITTED = 0x82EE;
enum uint GL_PRIMITIVES_SUBMITTED = 0x82EF;
enum uint GL_VERTEX_SHADER_INVOCATIONS = 0x82F0;
enum uint GL_TESS_CONTROL_SHADER_PATCHES = 0x82F1;
enum uint GL_TESS_EVALUATION_SHADER_INVOCATIONS = 0x82F2;
enum uint GL_GEOMETRY_SHADER_PRIMITIVES_EMITTED = 0x82F3;
enum uint GL_FRAGMENT_SHADER_INVOCATIONS = 0x82F4;
enum uint GL_COMPUTE_SHADER_INVOCATIONS = 0x82F5;
enum uint GL_CLIPPING_INPUT_PRIMITIVES = 0x82F6;
enum uint GL_CLIPPING_OUTPUT_PRIMITIVES = 0x82F7;
enum uint GL_POLYGON_OFFSET_CLAMP = 0x8E1B;
enum uint GL_SPIR_V_EXTENSIONS = 0x9553;
enum uint GL_NUM_SPIR_V_EXTENSIONS = 0x9554;
enum uint GL_TEXTURE_MAX_ANISOTROPY = 0x84FE;
enum uint GL_MAX_TEXTURE_MAX_ANISOTROPY = 0x84FF;
enum uint GL_TRANSFORM_FEEDBACK_OVERFLOW = 0x82EC;
enum uint GL_TRANSFORM_FEEDBACK_STREAM_OVERFLOW = 0x82ED;
...
enum uint GL_RENDERBUFFER_STORAGE_SAMPLES_AMD = 0x91B2;
enum uint GL_MAX_COLOR_FRAMEBUFFER_SAMPLES_AMD = 0x91B3;
enum uint GL_MAX_COLOR_FRAMEBUFFER_STORAGE_SAMPLES_AMD = 0x91B4;
enum uint GL_MAX_DEPTH_STENCIL_FRAMEBUFFER_SAMPLES_AMD = 0x91B5;
enum uint GL_NUM_SUPPORTED_MULTISAMPLE_MODES_AMD = 0x91B6;
enum uint GL_SUPPORTED_MULTISAMPLE_MODES_AMD = 0x91B7;
enum uint GL_SUBSAMPLE_DISTANCE_AMD = 0x883F;
enum uint GL_PIXELS_PER_SAMPLE_PATTERN_X_AMD = 0x91AE;
enum uint GL_PIXELS_PER_SAMPLE_PATTERN_Y_AMD = 0x91AF;
...
enum uint GL_FLOAT16_MAT2_AMD = 0x91C5;
enum uint GL_FLOAT16_MAT3_AMD = 0x91C6;
enum uint GL_FLOAT16_MAT4_AMD = 0x91C7;
enum uint GL_FLOAT16_MAT2x3_AMD = 0x91C8;
enum uint GL_FLOAT16_MAT2x4_AMD = 0x91C9;
enum uint GL_FLOAT16_MAT3x2_AMD = 0x91CA;
enum uint GL_FLOAT16_MAT3x4_AMD = 0x91CB;
enum uint GL_FLOAT16_MAT4x2_AMD = 0x91CC;
enum uint GL_FLOAT16_MAT4x3_AMD = 0x91CD;
...
enum uint GL_TEXTURE_TILING_EXT = 0x9580;
enum uint GL_DEDICATED_MEMORY_OBJECT_EXT = 0x9581;
enum uint GL_PROTECTED_MEMORY_OBJECT_EXT = 0x959B;
enum uint GL_NUM_TILING_TYPES_EXT = 0x9582;
enum uint GL_TILING_TYPES_EXT = 0x9583;
enum uint GL_OPTIMAL_TILING_EXT = 0x9584;
enum uint GL_LINEAR_TILING_EXT = 0x9585;
enum uint GL_NUM_DEVICE_UUIDS_EXT = 0x9596;
enum uint GL_DEVICE_UUID_EXT = 0x9597;
enum uint GL_DRIVER_UUID_EXT = 0x9598;
enum uint GL_HANDLE_TYPE_OPAQUE_FD_EXT = 0x9586;
enum uint GL_HANDLE_TYPE_OPAQUE_WIN32_EXT = 0x9587;
enum uint GL_HANDLE_TYPE_OPAQUE_WIN32_KMT_EXT = 0x9588;
enum uint GL_DEVICE_LUID_EXT = 0x9599;
enum uint GL_DEVICE_NODE_MASK_EXT = 0x959A;
enum uint GL_HANDLE_TYPE_D3D12_TILEPOOL_EXT = 0x9589;
enum uint GL_HANDLE_TYPE_D3D12_RESOURCE_EXT = 0x958A;
enum uint GL_HANDLE_TYPE_D3D11_IMAGE_EXT = 0x958B;
enum uint GL_HANDLE_TYPE_D3D11_IMAGE_KMT_EXT = 0x958C;
...
enum uint GL_LAYOUT_GENERAL_EXT = 0x958D;
enum uint GL_LAYOUT_COLOR_ATTACHMENT_EXT = 0x958E;
enum uint GL_LAYOUT_DEPTH_STENCIL_ATTACHMENT_EXT = 0x958F;
enum uint GL_LAYOUT_DEPTH_STENCIL_READ_ONLY_EXT = 0x9590;
enum uint GL_LAYOUT_SHADER_READ_ONLY_EXT = 0x9591;
enum uint GL_LAYOUT_TRANSFER_SRC_EXT = 0x9592;
enum uint GL_LAYOUT_TRANSFER_DST_EXT = 0x9593;
enum uint GL_LAYOUT_DEPTH_READ_ONLY_STENCIL_ATTACHMENT_EXT = 0x9530;
enum uint GL_LAYOUT_DEPTH_ATTACHMENT_STENCIL_READ_ONLY_EXT = 0x9531;
enum uint GL_HANDLE_TYPE_D3D12_FENCE_EXT = 0x9594;
enum uint GL_D3D12_FENCE_VALUE_EXT = 0x9595;
...
enum uint GL_TEXTURE_REDUCTION_MODE_EXT = 0x9366;
enum uint GL_WEIGHTED_AVERAGE_EXT = 0x9367;
...
enum uint GL_INCLUSIVE_EXT = 0x8F10;
enum uint GL_EXCLUSIVE_EXT = 0x8F11;
enum uint GL_WINDOW_RECTANGLE_EXT = 0x8F12;
enum uint GL_WINDOW_RECTANGLE_MODE_EXT = 0x8F13;
enum uint GL_MAX_WINDOW_RECTANGLES_EXT = 0x8F14;
enum uint GL_NUM_WINDOW_RECTANGLES_EXT = 0x8F15;
...
enum uint GL_BLACKHOLE_RENDER_INTEL = 0x83FC;
enum uint GL_CONSERVATIVE_RASTERIZATION_INTEL = 0x83FE;
...
enum uint GL_MAX_SHADER_COMPILER_THREADS_KHR = 0x91B0;
enum uint GL_COMPLETION_STATUS_KHR = 0x91B1;
...
enum uint GL_PROGRAM_BINARY_FORMAT_MESA = 0x875F;
enum uint GL_TILE_RASTER_ORDER_FIXED_MESA = 0x8BB8;
enum uint GL_TILE_RASTER_ORDER_INCREASING_X_MESA = 0x8BB9;
enum uint GL_TILE_RASTER_ORDER_INCREASING_Y_MESA = 0x8BBA;
...
enum uint GL_LGPU_SEPARATE_STORAGE_BIT_NVX = 0x0800;
enum uint GL_MAX_LGPU_GPUS_NVX = 0x92BA;
enum uint GL_ALPHA_TO_COVERAGE_DITHER_DEFAULT_NV = 0x934D;
enum uint GL_ALPHA_TO_COVERAGE_DITHER_ENABLE_NV = 0x934E;
enum uint GL_ALPHA_TO_COVERAGE_DITHER_DISABLE_NV = 0x934F;
enum uint GL_ALPHA_TO_COVERAGE_DITHER_MODE_NV = 0x92BF;
...
enum uint GL_VIEWPORT_POSITION_W_SCALE_NV = 0x937C;
enum uint GL_VIEWPORT_POSITION_W_SCALE_X_COEFF_NV = 0x937D;
enum uint GL_VIEWPORT_POSITION_W_SCALE_Y_COEFF_NV = 0x937E;
...
enum uint GL_CONSERVATIVE_RASTER_MODE_PRE_SNAP_NV = 0x9550;
enum uint GL_CONSERVATIVE_RASTER_MODE_NV = 0x954D;
enum uint GL_CONSERVATIVE_RASTER_MODE_POST_SNAP_NV = 0x954E;
enum uint GL_CONSERVATIVE_RASTER_MODE_PRE_SNAP_TRIANGLES_NV = 0x954F;
...
enum uint GL_PER_GPU_STORAGE_BIT_NV = 0x0800;
enum uint GL_MULTICAST_GPUS_NV = 0x92BA;
enum uint GL_RENDER_GPU_MASK_NV = 0x9558;
enum uint GL_PER_GPU_STORAGE_NV = 0x9548;
enum uint GL_MULTICAST_PROGRAMMABLE_SAMPLE_LOCATION_NV = 0x9549;
...
enum uint GL_ATTACHED_MEMORY_OBJECT_NV = 0x95A4;
enum uint GL_ATTACHED_MEMORY_OFFSET_NV = 0x95A5;
enum uint GL_MEMORY_ATTACHABLE_ALIGNMENT_NV = 0x95A6;
enum uint GL_MEMORY_ATTACHABLE_SIZE_NV = 0x95A7;
enum uint GL_MEMORY_ATTACHABLE_NV = 0x95A8;
enum uint GL_DETACHED_MEMORY_INCARNATION_NV = 0x95A9;
enum uint GL_DETACHED_TEXTURES_NV = 0x95AA;
enum uint GL_DETACHED_BUFFERS_NV = 0x95AB;
enum uint GL_MAX_DETACHED_TEXTURES_NV = 0x95AC;
enum uint GL_MAX_DETACHED_BUFFERS_NV = 0x95AD;
enum uint GL_MESH_SHADER_NV = 0x9559;
enum uint GL_TASK_SHADER_NV = 0x955A;
enum uint GL_MAX_MESH_UNIFORM_BLOCKS_NV = 0x8E60;
enum uint GL_MAX_MESH_TEXTURE_IMAGE_UNITS_NV = 0x8E61;
enum uint GL_MAX_MESH_IMAGE_UNIFORMS_NV = 0x8E62;
enum uint GL_MAX_MESH_UNIFORM_COMPONENTS_NV = 0x8E63;
enum uint GL_MAX_MESH_ATOMIC_COUNTER_BUFFERS_NV = 0x8E64;
enum uint GL_MAX_MESH_ATOMIC_COUNTERS_NV = 0x8E65;
enum uint GL_MAX_MESH_SHADER_STORAGE_BLOCKS_NV = 0x8E66;
enum uint GL_MAX_COMBINED_MESH_UNIFORM_COMPONENTS_NV = 0x8E67;
enum uint GL_MAX_TASK_UNIFORM_BLOCKS_NV = 0x8E68;
enum uint GL_MAX_TASK_TEXTURE_IMAGE_UNITS_NV = 0x8E69;
enum uint GL_MAX_TASK_IMAGE_UNIFORMS_NV = 0x8E6A;
enum uint GL_MAX_TASK_UNIFORM_COMPONENTS_NV = 0x8E6B;
enum uint GL_MAX_TASK_ATOMIC_COUNTER_BUFFERS_NV = 0x8E6C;
enum uint GL_MAX_TASK_ATOMIC_COUNTERS_NV = 0x8E6D;
enum uint GL_MAX_TASK_SHADER_STORAGE_BLOCKS_NV = 0x8E6E;
enum uint GL_MAX_COMBINED_TASK_UNIFORM_COMPONENTS_NV = 0x8E6F;
enum uint GL_MAX_MESH_WORK_GROUP_INVOCATIONS_NV = 0x95A2;
enum uint GL_MAX_TASK_WORK_GROUP_INVOCATIONS_NV = 0x95A3;
enum uint GL_MAX_MESH_TOTAL_MEMORY_SIZE_NV = 0x9536;
enum uint GL_MAX_TASK_TOTAL_MEMORY_SIZE_NV = 0x9537;
enum uint GL_MAX_MESH_OUTPUT_VERTICES_NV = 0x9538;
enum uint GL_MAX_MESH_OUTPUT_PRIMITIVES_NV = 0x9539;
enum uint GL_MAX_TASK_OUTPUT_COUNT_NV = 0x953A;
enum uint GL_MAX_DRAW_MESH_TASKS_COUNT_NV = 0x953D;
enum uint GL_MAX_MESH_VIEWS_NV = 0x9557;
enum uint GL_MESH_OUTPUT_PER_VERTEX_GRANULARITY_NV = 0x92DF;
enum uint GL_MESH_OUTPUT_PER_PRIMITIVE_GRANULARITY_NV = 0x9543;
enum uint GL_MAX_MESH_WORK_GROUP_SIZE_NV = 0x953B;
enum uint GL_MAX_TASK_WORK_GROUP_SIZE_NV = 0x953C;
enum uint GL_MESH_WORK_GROUP_SIZE_NV = 0x953E;
enum uint GL_TASK_WORK_GROUP_SIZE_NV = 0x953F;
enum uint GL_MESH_VERTICES_OUT_NV = 0x9579;
enum uint GL_MESH_PRIMITIVES_OUT_NV = 0x957A;
enum uint GL_MESH_OUTPUT_TYPE_NV = 0x957B;
enum uint GL_UNIFORM_BLOCK_REFERENCED_BY_MESH_SHADER_NV = 0x959C;
enum uint GL_UNIFORM_BLOCK_REFERENCED_BY_TASK_SHADER_NV = 0x959D;
enum uint GL_ATOMIC_COUNTER_BUFFER_REFERENCED_BY_MESH_SHADER_NV = 0x959E;
enum uint GL_ATOMIC_COUNTER_BUFFER_REFERENCED_BY_TASK_SHADER_NV = 0x959F;
enum uint GL_REFERENCED_BY_MESH_SHADER_NV = 0x95A0;
enum uint GL_REFERENCED_BY_TASK_SHADER_NV = 0x95A1;
enum uint GL_MESH_SUBROUTINE_NV = 0x957C;
enum uint GL_TASK_SUBROUTINE_NV = 0x957D;
enum uint GL_MESH_SUBROUTINE_UNIFORM_NV = 0x957E;
enum uint GL_TASK_SUBROUTINE_UNIFORM_NV = 0x957F;
enum uint GL_MESH_SHADER_BIT_NV = 0x00000040;
enum uint GL_TASK_SHADER_BIT_NV = 0x00000080;
...
enum uint GL_QUERY_RESOURCE_TYPE_VIDMEM_ALLOC_NV = 0x9540;
enum uint GL_QUERY_RESOURCE_MEMTYPE_VIDMEM_NV = 0x9542;
enum uint GL_QUERY_RESOURCE_SYS_RESERVED_NV = 0x9544;
enum uint GL_QUERY_RESOURCE_TEXTURE_NV = 0x9545;
enum uint GL_QUERY_RESOURCE_RENDERBUFFER_NV = 0x9546;
enum uint GL_QUERY_RESOURCE_BUFFEROBJECT_NV = 0x9547;
...
enum uint GL_REPRESENTATIVE_FRAGMENT_TEST_NV = 0x937F;
enum uint GL_PURGED_CONTEXT_RESET_NV = 0x92BB;
...
enum uint GL_SCISSOR_TEST_EXCLUSIVE_NV = 0x9555;
enum uint GL_SCISSOR_BOX_EXCLUSIVE_NV = 0x9556;
...
enum uint GL_SHADING_RATE_IMAGE_NV = 0x9563;
enum uint GL_SHADING_RATE_NO_INVOCATIONS_NV = 0x9564;
enum uint GL_SHADING_RATE_1_INVOCATION_PER_PIXEL_NV = 0x9565;
enum uint GL_SHADING_RATE_1_INVOCATION_PER_1X2_PIXELS_NV = 0x9566;
enum uint GL_SHADING_RATE_1_INVOCATION_PER_2X1_PIXELS_NV = 0x9567;
enum uint GL_SHADING_RATE_1_INVOCATION_PER_2X2_PIXELS_NV = 0x9568;
enum uint GL_SHADING_RATE_1_INVOCATION_PER_2X4_PIXELS_NV = 0x9569;
enum uint GL_SHADING_RATE_1_INVOCATION_PER_4X2_PIXELS_NV = 0x956A;
enum uint GL_SHADING_RATE_1_INVOCATION_PER_4X4_PIXELS_NV = 0x956B;
enum uint GL_SHADING_RATE_2_INVOCATIONS_PER_PIXEL_NV = 0x956C;
enum uint GL_SHADING_RATE_4_INVOCATIONS_PER_PIXEL_NV = 0x956D;
enum uint GL_SHADING_RATE_8_INVOCATIONS_PER_PIXEL_NV = 0x956E;
enum uint GL_SHADING_RATE_16_INVOCATIONS_PER_PIXEL_NV = 0x956F;
enum uint GL_SHADING_RATE_IMAGE_BINDING_NV = 0x955B;
enum uint GL_SHADING_RATE_IMAGE_TEXEL_WIDTH_NV = 0x955C;
enum uint GL_SHADING_RATE_IMAGE_TEXEL_HEIGHT_NV = 0x955D;
enum uint GL_SHADING_RATE_IMAGE_PALETTE_SIZE_NV = 0x955E;
enum uint GL_MAX_COARSE_FRAGMENT_SAMPLES_NV = 0x955F;
enum uint GL_SHADING_RATE_SAMPLE_ORDER_DEFAULT_NV = 0x95AE;
enum uint GL_SHADING_RATE_SAMPLE_ORDER_PIXEL_MAJOR_NV = 0x95AF;
enum uint GL_SHADING_RATE_SAMPLE_ORDER_SAMPLE_MAJOR_NV = 0x95B0;
...
enum uint GL_VIEWPORT_SWIZZLE_POSITIVE_X_NV = 0x9350;
enum uint GL_VIEWPORT_SWIZZLE_NEGATIVE_X_NV = 0x9351;
enum uint GL_VIEWPORT_SWIZZLE_POSITIVE_Y_NV = 0x9352;
enum uint GL_VIEWPORT_SWIZZLE_NEGATIVE_Y_NV = 0x9353;
enum uint GL_VIEWPORT_SWIZZLE_POSITIVE_Z_NV = 0x9354;
enum uint GL_VIEWPORT_SWIZZLE_NEGATIVE_Z_NV = 0x9355;
enum uint GL_VIEWPORT_SWIZZLE_POSITIVE_W_NV = 0x9356;
enum uint GL_VIEWPORT_SWIZZLE_NEGATIVE_W_NV = 0x9357;
enum uint GL_VIEWPORT_SWIZZLE_X_NV = 0x9358;
enum uint GL_VIEWPORT_SWIZZLE_Y_NV = 0x9359;
enum uint GL_VIEWPORT_SWIZZLE_Z_NV = 0x935A;
enum uint GL_VIEWPORT_SWIZZLE_W_NV = 0x935B;
...
enum uint GL_FRAMEBUFFER_INCOMPLETE_VIEW_TARGETS_OVR = 0x9633;
