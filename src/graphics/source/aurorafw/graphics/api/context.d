...
import aurorafw.graphics.opengl.context : GLContext;
import aurorafw.graphics.vulkan.context : VKContext;
...
class Context {
	...
	static void init(NativeWindow win)
	{
		_instance._init(win);
	}
