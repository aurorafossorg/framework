...
PDFVersion getPDFVersion(File file)
{
	...
	if(buf == "-1.0") return PDFVersion.PDF_1_0;
	else if(buf == "-1.1") return PDFVersion.PDF_1_1;
	else if(buf == "-1.2") return PDFVersion.PDF_1_2;
	else if(buf == "-1.3") return PDFVersion.PDF_1_3;
	else if(buf == "-1.4") return PDFVersion.PDF_1_4;
	else if(buf == "-1.5") return PDFVersion.PDF_1_5;
	else if(buf == "-1.6") return PDFVersion.PDF_1_6;
	else if(buf == "-1.7") return PDFVersion.PDF_1_7;
	else if(buf == "-2.0") return PDFVersion.PDF_2_0;
